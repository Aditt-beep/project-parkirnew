...
<!-- TOPBAR -->
<div class="topbar">
    <span class="topbar-title">Beranda Petugas</span>
</div>
...
<div class="sidebar">
    ...
    <div class="sidebar-section">
        ...
        <a href="v_homepetugas.php" class="nav-item active">
            <svg viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
            Beranda
        </a>

        <a href="../Controller/c_transaksi.php" class="nav-item">
    ...
    <div class="content">
        ...
        <div class="welcome-banner">
            ...
            <div class="welcome-text">
                ...
                <p>Kamu login sebagai Petugas. Kelola transaksi parkir dari sini.</p>
            </div>
        </div>

        <!-- Page Section -->
        <div class="page-section-title">Selamat Datang di Portal Petugas</div>
        <div class="page-section-sub">Gunakan menu di samping untuk mengelola transaksi parkir harian.</div>
        ...
        <div class="info-card">
            ...
            <div class="info-card-body">
                <div class="quick-links">
                    <a href="../Controller/c_transaksi.php" class="quick-btn">
                        <svg viewBox="0 0 24 24"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                        Tambah Transaksi
                    </a>
                    <a href="../Controller/c_transaksi.php" class="quick-btn outline">
                        <svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="8" y1="13" x2="16" y2="13"/></svg>
                        Lihat Transaksi
                    </a>
                </div>
            </div>
