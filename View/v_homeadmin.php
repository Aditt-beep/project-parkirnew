...
<div class="topbar">
    ...
    <div class="topbar-user">
        <div class="avatar"><?= strtoupper(substr($_SESSION['data']['username'], 0, 1)); ?></div>
        <span><?= htmlspecialchars($_SESSION['data']['username']); ?></span>
    </div>
</div>
    ...
    <div class="content">
        ...
        <div class="welcome-banner">
            ...
            <div class="welcome-text">
                ...
                <p>Kamu login sebagai Admin. Kelola sistem parkir dari sini.</p>
            </div>
        </div>

        <!-- Section Title -->
        <div class="page-section-title">Selamat Datang di Dashboard Admin</div>
        <div class="page-section-sub">Gunakan menu di samping untuk mengelola seluruh data sistem parkir.</div>
